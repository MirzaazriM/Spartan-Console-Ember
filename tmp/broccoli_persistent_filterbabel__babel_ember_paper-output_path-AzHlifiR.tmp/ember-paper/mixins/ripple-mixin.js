define('ember-paper/mixins/ripple-mixin', ['exports', 'ember-paper/utils/browser-features'], function (exports, _browserFeatures) {
  'use strict';
  ...
  exports.default = Ember.Mixin.create({
    ...
    bindEvents() {
      ...
      let options = _browserFeatures.supportsPassiveEventListeners ? { passive: true } : false;
