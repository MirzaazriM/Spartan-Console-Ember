define('ember-paper/components/paper-grid-tile', ['exports', 'ember-paper/templates/components/paper-grid-tile', 'ember-composability-tools', 'ember-invoke-action'], function (exports, _paperGridTile, _emberComposabilityTools, _emberInvokeAction) {
  'use strict';
  ...
  exports.default = Ember.Component.extend(_emberComposabilityTools.ChildMixin, {
    ...
    gridList: Ember.computed.alias('parentComponent'),
    ...
    didUpdateAttrs() {
      ...
      Ember.run.debounce(gridList, gridList.updateGrid, 0);
    },
    ...
    colspanMedia: Ember.computed('colspan', function () {
      return this.get('gridList')._extractResponsiveSizes(this.get('colspan'));
    }),

    currentColspan: Ember.computed('colspanMedia', 'gridList.currentMedia.[]', function () {
    ...
    rowspanMedia: Ember.computed('rowspan', function () {
      return this.get('gridList')._extractResponsiveSizes(this.get('rowspan'));
    }),

    currentRowspan: Ember.computed('rowspanMedia', 'gridList.currentMedia.[]', function () {
