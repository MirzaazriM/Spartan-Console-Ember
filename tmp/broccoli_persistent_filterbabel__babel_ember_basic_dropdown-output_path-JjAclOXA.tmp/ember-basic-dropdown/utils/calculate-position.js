define('ember-basic-dropdown/utils/calculate-position', ['exports'], function (exports) {
  ...
  exports.default = function (_, _2, _destination, { renderInPlace }) {
    if (renderInPlace) {
  ...
  function calculateWormholedPosition(trigger, content, destination, { horizontalPosition, verticalPosition, matchTriggerWidth, previousHorizontalPosition, previousVerticalPosition }) {
    ...
    */
  function calculateInPlacePosition(trigger, content, destination, { horizontalPosition, verticalPosition /*, matchTriggerWidth, previousHorizontalPosition, previousVerticalPosition */ }) {
    let dropdownRect;
    let positionData = {};
