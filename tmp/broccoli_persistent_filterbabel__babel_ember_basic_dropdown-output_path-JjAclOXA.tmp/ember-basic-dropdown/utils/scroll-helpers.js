define('ember-basic-dropdown/utils/scroll-helpers', ['exports'], function (exports) {
   ...
   */
  const DOM_DELTA_PIXEL = exports.DOM_DELTA_PIXEL = 0;
  /**
   ...
   */
  const DOM_DELTA_LINE = exports.DOM_DELTA_LINE = 1;
  /**
   ...
   * Reference: https://stackoverflow.com/a/37474225
   */
  const DOM_DELTA_PAGE = exports.DOM_DELTA_PAGE = 2;
   ...
   */
  const LINES_PER_PAGE = exports.LINES_PER_PAGE = 3;
   ...
   */
  function getScrollDeltas({ deltaX = 0, deltaY = 0, deltaMode = DOM_DELTA_PIXEL }) {
